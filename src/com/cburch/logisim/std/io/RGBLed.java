...
public class RGBLed extends InstanceFactory {
	...
	public RGBLed() {
		...
		Port[] ps = new Port[3];
		ps[RED] = new Port(0, 10, Port.INPUT, 1);
		ps[GREEN] = new Port(10, 10, Port.INPUT, 1);
		ps[BLUE] = new Port(20, 10, Port.INPUT, 1);
	...
	public void paintInstance(InstancePainter painter) {
		...
		g.drawLine(bds.getX(), bds.getY() + bds.getHeight(), bds.getX() + bds.getWidth()/2, bds.getY() + bds.getHeight()/2);
		g.drawLine(bds.getX() + bds.getWidth(), bds.getY() + bds.getHeight(), bds.getX() + bds.getWidth()/2, bds.getY() + bds.getHeight()/2);
