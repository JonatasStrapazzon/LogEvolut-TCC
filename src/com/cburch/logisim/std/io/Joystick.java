...
public class Joystick extends InstanceFactory {
	...
	public static class Poker extends InstancePoker {
		...
		public void mouseReleased(InstanceState state, MouseEvent e) {
                        boolean Reset = state.getAttributeValue(ATTR_RESET);
                        if(Reset)
	...
	static final Attribute<Boolean> ATTR_RESET = Attributes.forBoolean(
                        "reset", Strings.getter("joystickReset"));

        
	public Joystick() {
		super("Joystick", Strings.getter("joystickComponent"));
		setAttributes(new Attribute[] { ATTR_WIDTH, Io.ATTR_COLOR, ATTR_RESET },
				new Object[] { BitWidth.create(4), Color.RED, false });
	...
	public void paintInstance(InstancePainter painter) {
		...
		drawBall(g, CurX, CurY, painter.getAttributeValue(Io.ATTR_COLOR),
