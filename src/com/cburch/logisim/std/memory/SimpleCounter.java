...
public class SimpleCounter extends InstanceFactory {

	public static int SymbolWidth(int NrOfBits) {
		return 150 + ((NrOfBits - 8) / 5) * 10;
	}

	final static Logger logger = LoggerFactory.getLogger(SimpleCounter.class);
	...
	public SimpleCounter() {
		super("SimpleCounter", Strings.getter("simpleCounterComponent"));
		setOffsetBounds(Bounds.create(0, 0, 30, 40));
		setIconName("counter.gif");
		setInstancePoker(SimpleCounterPoker.class);
	...
	public AttributeSet createAttributeSet() {
		return new SimpleCounterAttributes();
	}
	...
	public boolean HDLSupportedComponent(String HDLIdentifier,
		...
		if (MyHDLGenerator == null)
			MyHDLGenerator = new SimpleCounterHDLGeneratorFactory();
